    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Войдите в аккаунт, чтобы управлять профилем</p>
        </div>
        ...
        {activeTab === 'register' && (
          <p className="text-center text-sm text-muted-foreground mt-6">
            Примечание: Вы также можете зарегистрироваться в игре, используя <code className="text-primary bg-primary/10 px-1 rounded">/register pass pass</code>
          </p>
        )}
      </div>
    </div>
