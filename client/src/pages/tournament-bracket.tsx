        ...
        {isAdmin && (
          <div className="mt-20 p-8 rounded-3xl bg-white/5 border border-white/10">
            ...
            <ul className="space-y-3 list-disc list-inside">
              ...
              <li>Для 4 команд: заполните 2 матча в Полуфинале. Победители автоматически пройдут в Финал.</li>
              <li>Чтобы продвижение сработало: установите <b>Победителя</b> и статус <b>Завершен</b>.</li>
            </ul>
              <ul className="space-y-3 list-disc list-inside">
                <li>Статус "LIVE" добавит пульсирующий бейдж на карточку матча.</li>
                <li>После завершения матча победитель будет подсвечен и перемещен в следующий раунд.</li>
                <li>Кнопка "Сбросить всё" очистит всю данные и создаст новую сетку на 4 команды.</li>
              </ul>
            </div>
          </div>
        )}
