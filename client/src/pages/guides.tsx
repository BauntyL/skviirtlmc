  ...
  const guides = [
    {
      ...
      category: "Основы",
      icon: MessageSquare,
      description: "На сервере есть Глобальный [G], Локальный [L] и Торговый [T] чаты. Используйте /g <сообщение> для сообщений на весь сервер, /l <сообщение> для общения поблизости и /t <сообщение> для торговых предложений.",
      links: [
