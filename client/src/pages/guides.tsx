  ...
  const guides = [
    {
      ...
      category: "Основы",
      icon: MessageSquare,
      description: "На сервере есть Глобальный [G], Локальный [L] и Торговый [T] чаты. Используйте /g <текст> для сообщений на весь сервер, /l <текст> для общения поблизости и /t <текст> для торговых предложений.",
      links: [
