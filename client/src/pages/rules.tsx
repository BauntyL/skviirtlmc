                    ...
                    <AccordionContent className="text-muted-foreground pb-6">
                      <div className="space-y-4">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          <li><span className="text-white font-bold">Глобальный чат [G]</span> — <span className="text-primary font-bold">/g &lt;сообщение&gt;</span>. Сообщение видно всем игрокам на сервере.</li>
